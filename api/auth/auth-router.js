...
const { checkEmailExists, checkEmailFree, validateRegisterCred, validateLoginCred} = require('../middleware/auth-middleware');
...
router.post('/register', validateRegisterCred, checkEmailFree, (req, res, next) => {
  let user = req.body;
